...
class WindowsTitleBar(QFrame):
    ...
    def __init__(self, window: MainWindow) -> None:
        ...
        self.workspace_button = QToolButton(self)
        self.workspace_button.setObjectName("workspaceButton")
        self.workspace_button.setAutoRaise(True)
        self.workspace_button.setCheckable(True)
        self.workspace_button.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_DesktopIcon))
        self.workspace_button.setToolTip(_("Workspace: hide the left panel"))
        self.workspace_button.setFixedSize(36, 32)
        self.workspace_button.clicked.connect(window._toggle_workspace)
